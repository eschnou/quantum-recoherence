...
We verify that the effect is robust: it appears across system sizes from
$D = 128$ to $D = 1024$, persists under different coarse-graining projectors
(including a spatially biased projector structurally unlike Hamming weight), and
is insensitive to the choice of decoherence threshold.
The filtering strength is governed primarily by the projector asymmetry
$|p_1 - 1/2|$, with larger Hilbert spaces amplifying the effect at fixed
asymmetry.
\end{abstract}
