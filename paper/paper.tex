...
% ============================================================================
\section{Interpretive Discussion}
\label{sec:interp}
% ============================================================================

\emph{The numerical results in Section~\ref{sec:experiment} stand on their own.
This section offers speculative interpretive commentary---our reading of what the
filtering mechanism might mean if it generalizes beyond toy models. These are
philosophical proposals, not consequences of the simulation alone, and they go
beyond what Strasberg and collaborators claim in the attached references.}
...
Bohm's pilot-wave theory~\citep{Bohm1952} shares the single-thread intuition: one
...
the coarse-graining basis (Section~\ref{sec:interp}): the preferred observable is
...
\newblock A Suggested Interpretation of the Quantum Theory in Terms of ``Hidden''
  Variables. I and II.
\newblock \emph{Physical Review}, 85(2):166--193, 1952.
